...
print "initialized and made transition chains"
...
print "run determine_Q (can we recreate a row given some of its values:?)"
...
for actual_row_idx in [1, 10, 100]:
    ...
    print "actual_row idx: "
    print actual_row_idx
